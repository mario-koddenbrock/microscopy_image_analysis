...
from mia.utils import initialize_evaluators, evaluate_image, evaluate_dataset, get_class_files, get_dataset_classes
...
class TestUtils(unittest.TestCase):
    ...
    @patch('mia.utils.plotting.show_prediction_result', return_value='result_image_path')
    ...
    @patch('mia.utils.get_class_files', return_value=['datasets/Classification/Acinetobacter.baumanii/Acinetobacter.baumanii_0001.tif', 'datasets/Classification/Acinetobacter.baumanii/Acinetobacter.baumanii_0002.tif'])
    @patch('mia.utils.plotting.show_prediction_result', return_value='result_image_path')
    def test_evaluate_dataset(self, mock_show_prediction_result, mock_get_class_files, mock_get_dataset_classes):
        evaluators = {'evaluator1': MagicMock()}
        ...
        num_classes = 2
        result = evaluate_dataset(evaluators, dataset_name, dataset_description, dataset_path, num_images_per_class, num_classes)
    ...
    def test_get_class_files(self, mock_exists, mock_listdir):
        ...
        self.assertEqual(result, ['path/to/dataset/class1/image1.jpg', 'path/to/dataset/class1/image2.jpg'])
