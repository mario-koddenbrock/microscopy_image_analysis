...
class DatasetDownloader:
    ...
    def download_and_extract(self):
        if isinstance(self.datasets, dict):
            ...
            print(
                "Datasets should be either a list of URLs or a dictionary of name: url pairs."
            )
    ...
    def _extract_file(self, file_path):
        ...
        if file_name.endswith(".zip"):
            ...
            print(
                f"File {file_name} is not an archive or unsupported format, skipping extraction."
            )
...
if __name__ == "__main__":
    ...
    downloader = DatasetDownloader(
        segmentation_datasets, download_dir=os.path.join("../datasets", "Segmentation")
    )
    downloader.download_and_extract()
    ...
    downloader = DatasetDownloader(
        object_detection_datasets,
        download_dir=os.path.join("../datasets", "ObjectDetection"),
    )
    downloader.download_and_extract()
